...
function addRoutes(samplesList) {
    var loop1 = function(node) {
        ...
        var loop2 = function(subNode) {
            ...
            if (location.pathname.indexOf(urlString) !== -1) {
...
function onDataSourceLoad(node, subNode, control, sample, sampleName) {
    ...
    setSbLink();
    var ajaxCS = new ej.base.Ajax('/Controllers/' + subNode.dir + '/' + subNode.url + 'Controller.cs', 'GET', false);
    var ajaxCSHTML = new ej.base.Ajax('/Views/' + subNode.dir + '/' + subNode.url + '.cshtml', 'GET', false);
